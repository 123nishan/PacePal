package com.nishan.core.presentation.ui

import com.nishan.core.domain.util.DataError
...
//        DataError.Network.CONFLICT ->UiText.StringResource(R.string.error_disk_full)
        DataError.Network.TOO_MANY_REQUESTS -> UiText.StringResource(R.string.error_to_many_request)
